...
> 版本：V1.2 ｜ 创建：2026-08-24 ｜ 最后更新：**2026-09-16（第二十一轮）** ｜ Harness 版本：0.1.0-rc.11
...
> ⚠️ 本节数字为 **2026-09-16** 快照。**当前权威读数一律以 `docs/00-统筹入口/10-当前基线-落死锚点-V16.md` §一 为准**：
> 插件产物 `lib/client.js` **1,854,200 B / 85 模块 / 绑定对账 711 = 711（252 import）/ 内容指纹 `0c43c1d001267747`**；
> 真机 `verify-novel-split` **106/106**（连跑 2 次，含**清除前快照 → 界面一键恢复 → 幂等复点 → 哨兵收尾**完整还原链）· 连跑 10 次恒「复用 8 · 新建 0 · 净增 0」；离线全量 **56 套 / PASS 44**；
> 总监消息**清除自带退路**（`dsh.director.msgs.backup` 快照 + 界面「↩ 恢复」）· 会话清理 = **四层落点全 0**（磁盘 / 登记 / 投影缓存 / `localStorage`）+ 宿主下架 134 条。
...
| 测试 | 真机 **106/106 ×2 轮** · **70/70** · **39/39**；离线 **269/269** · **60/60** · **49/49** 等全绿 |
