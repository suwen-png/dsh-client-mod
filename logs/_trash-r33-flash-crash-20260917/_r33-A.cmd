...
set "LOG=D:\hermes-data\dsh-client-mod\dsh-director-plugin\logs\_r33-A.log"
...
"%NODE_EXE%" "D:\hermes-data\dsh-client-mod\dsh-director-plugin\scripts\start-harness.mjs" %* >>"D:\hermes-data\dsh-client-mod\dsh-director-plugin\logs\_r33-A-stdout.txt" 2>&1
set "RC=%ERRORLEVEL%"
>>"%LOG%" echo [cmd] script exit %RC%
echo.
if "%RC%"=="0" goto ok
echo [FAIL] exit code %RC% -- see the messages above.
echo        Log: dsh-director-plugin\logs\_r33-A.log
echo.
echo  NOTES:
