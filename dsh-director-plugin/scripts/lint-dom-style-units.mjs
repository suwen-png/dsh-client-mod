 ...
 * ══════════════════════════════════════════════════════════════════ */
console.log("\n【L4 覆盖度自证】");
C("L4a 确实扫到了直接样式赋值点（包裹 " + totalWrapped + " / 直写 " + totalDirect + "）",
	totalWrapped + totalDirect >= 8, "扫描 " + files.length + " 文件");
C("L4b 有可静态判定的包裹调用（wrapped ≥ 5）", totalWrapped >= 5, "wrapped=" + totalWrapped);
