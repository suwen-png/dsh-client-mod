...
const p1 = projectOf("帮我写一个小说《墟海》，项目根 D:\\workspace\\novels\\墟海，先搭世界观");
t("DD-1", "反斜杠绝对路径：`root` 命中、`name` = 末段 `墟海`",
	p1.root === "D:\\workspace\\novels\\墟海" && p1.name === "墟海", p1);
const p2 = projectOf("读一下 d:/workspace/novels/墟海/ 里面的资料");
t("DD-2", "正斜杠 + 小写盘符 + 尾斜杠：命中且 `name` **不带**尾斜杠",
	p2.root === "d:/workspace/novels/墟海" && p2.name === "墟海", p2);
...
t("DD-6", "🔴 **负对照**：相对路径 / 只有盘符 ⇒ 不匹配（必须「盘符 + 分隔符 + 至少一层」）",
	projectOf("读 ./novels/墟海").root === null
	&& projectOf("读 novels\\墟海").root === null
	&& projectOf("盘符 D:").root === null
	&& projectOf("D:\\").root === null,
	{ a: projectOf("读 ./novels/墟海"), b: projectOf("D:\\") });
...
t("DD-8", "真机原话复现 ⇒ 提取出 `D:\\workspace\\novels\\墟海`",
	projectOf(speech).root === "D:\\workspace\\novels\\墟海" && projectOf(speech).name === "墟海", projectOf(speech));
